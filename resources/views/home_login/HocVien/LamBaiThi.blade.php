			...
			<table class="table table-bordered" cellpadding="4" cellspacing="4">
				<thead>
					<tr>
						...
						<th colspan="2"><a href="HocVien/DoTest/{{$dethi->idDeThi}}"><button type="button" class="btn btn-danger">Bat Dau Lam Bai</button></a><p>Hãy nhấn vào nút bắt đầu bắt đầu để thi</p></th>
					</tr>
				</thead>
				<tbody>
					<tr>
