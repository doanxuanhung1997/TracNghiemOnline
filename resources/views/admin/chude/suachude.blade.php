            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    {{--  Hiển thị thông báo thành công --}}
                        ...
                        <form action="admin/chude/sua/{{$chude->idChuDe}}" method="POST">
                                <input type="hidden" name="_token" value="{{csrf_token()}}"/>   
                               {{--  {{csrf_field()}} --}}
                                <div class="form-group">
                                    <label>Tên Chủ Đề</label>
                                    <input type="text" class="form-control" name="TenChuDe" value="{{ $chude->TenChuDe }}" />
                                </div>
