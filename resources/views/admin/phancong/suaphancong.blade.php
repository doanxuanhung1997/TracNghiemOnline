            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    {{--  Hiển thị thông báo thành công --}}
                        ...
                        <form action="admin/phancong/sua/{{$phancong->idGiangVienHT}}&{{$phancong->idMonHoc}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="GiangVien">
                                        @foreach($giangvien as $gv) 
                                            <option 
                                            @if($phancong->idGiangVienHT==$gv->id) 
                                                {{ "selected" }} 
                                            @endif
                                            value="{{ $gv->id }}">{{ $gv->HoTen }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="MonHoc">
                                        @foreach($monhoc as $mh) 
                                            <option 
                                            @if($phancong->idMonHoc==$mh->idMonHoc) 
                                                {{ "selected" }} 
                                            @endif
                        ...
                        <a href="admin/phancong/danhsach">
